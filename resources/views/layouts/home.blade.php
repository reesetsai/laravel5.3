...
<!--sidebar start-->
			<div class="col-md-4">
	    		<div class="primary-sidebar widget-area" role="complementary">
	        		...
	        		<aside id="shapedtheme_about_widget-2" class="widget shapedtheme_about_widget">			
						<div class="about-widget">
							<img class="img-responsive" src="{{asset('uploads/485367_4078645059559_62536364_n.jpg')}}" alt="About Me" style="width: 173px;height: 200px;" />
							<div class="about-me-title text-center">About Me</div>
	            			...
	            			<div class="social-link text-center">
                                ...
                                <a href="#" class="bloglovin"><i class="fa fa-heart"></i></a>    
	            			</div>
						</div>
					</aside>
					...
					<aside class="widget">
						...
						<div class="tagcloud">
							@foreach($str_tag as $key=>$value)
								<a href="{{url('/category/'.$value)}}" title="">{{$value}}</a>
							@endforeach
						</div>
					</aside>
