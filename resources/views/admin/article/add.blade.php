...
<div class="crumb_warp">
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首頁</a> &raquo; 新增文章
    </div>
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            @foreach($data as $style)
                                <option value="{{$style->cate_id}}">{{$style->_cate_name}}</option>
                            @endforeach
                            </select>
                        </td>
                    </tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_title" id="art_title" >
                        </td>
                    </tr>
                    <tr>
                        <th>作者：</th>
                        <td>
                            <input type="text" class="sm" name="art_editor" id="art_editor">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require"></i>縮圖：</th>
                        <td>
                            <input type="text" class="lg" size="50" name="art_thumb" id="art_thumb">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="" alt="" id="art_thumb_img" style="max-height: 350px;max-width: 300px;">
                        </td>
                    </tr>
                    <tr>
                        <th>關鍵字：</th>
                        <td>
                            <input type="text" class="lg" name="art_tag" id="art_tag">
                        </td>
                    </tr>
                    <tr>
                        <th>內容描述：</th>
